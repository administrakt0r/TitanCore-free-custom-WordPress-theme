document.addEventListener("DOMContentLoaded", () => {
    ...
    const initActiveMenuAttributes = () => {
        const currentItemLinks = document.querySelectorAll(
        ...
        currentItemLinks.forEach((link) => {
            if (!link.hasAttribute("aria-current")) {
                link.setAttribute("aria-current", "page");
            }
        });

        const currentParentLinks = document.querySelectorAll(
            "header nav li.current-menu-parent > a, header nav li.current-menu-ancestor > a, header nav li.current_page_parent > a, header nav li.current_page_ancestor > a, #mobile-menu li.current-menu-parent > a, #mobile-menu li.current-menu-ancestor > a, #mobile-menu li.current_page_parent > a, #mobile-menu li.current_page_ancestor > a"
        );
        currentParentLinks.forEach((link) => {
            if (!link.hasAttribute("aria-current")) {
                link.setAttribute("aria-current", "true");
            }
        });
