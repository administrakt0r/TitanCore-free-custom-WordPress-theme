...
= 1.0.5 =
* UI/UX: Enhanced mobile navigation toggle button open-state affordance with ring focus outline styling.
* UI/UX: Expanded parent/ancestor navigation link styling and aria-current attributes for current-menu-parent, current-menu-ancestor, current_page_parent, and current_page_ancestor in primary and mobile menus.
* Accessibility & UI: Normalized comment form inputs and submit button touch targets (44px min-height) with consistent focus ring outlines.
